...
class CustomRFECV(BaseEstimator, TransformerMixin):
    def __init__(self, model, scorer, metric_direction, loss_threshold, cv):
        ...
        self.cv = cv # To compute ROC AUC for multiclass targets (One vs rest)
    ...
    def fit(self, X, y):
        ...
        while improvement:
            ...
            for feature in features:
                ...
                # If the score does not decrease more than the threshold, check if is the wors feature according to the score FOR REMOVAL in the iter
