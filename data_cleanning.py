...
class DataCleanning(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X, y=None):
        ...
        for feature in self.multi_label_binarizer_features:
            ...
            # Creation of the binary feature 'Unknown' for unknown values that appear in test but not seen on train. The list corresponds to all training detected features
    ...
    # This method creates a list of each of the strings that are delimited by ',' and also handles other issues that can appear. 
    @staticmethod
    ...
    # Method to rename nan column created from multilabel binarizer to 'Missing_loan'
    @staticmethod
